...
export default function PricingBox({ pricePerMonth, currency, forRent, securityDeposit, maintenance, onBook, onScheduleTour }: Props) {
    return (
        <div className="sm:rounded-lg bg-white sm:shadow p-5 mx-auto max-w-[380px] space-y-1">
            <div className="flex items-center justify-between mb-3">
                ...
                {forRent ? <span className="bg-blue-100 text-blue-600 px-3 py-1.5 rounded-lg text-xs font-semibold">For Rent</span>
                    : <span className="bg-green-100 text-green-600">For Sale</span>}
            </div>
            <div className="text-sm text-gray-500">Security Deposit: {securityDeposit}</div>
            <div className="text-sm text-gray-500 mb-3">Maintenance: {maintenance}/month</div>
