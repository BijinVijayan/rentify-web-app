...
const HostCallToAction = () => {
    return (
        <div className={"max-w-7xl mx-auto py-10"}>
            <div className={"bg-sky-800 p-5 py-10 sm:p-20 sm:rounded-xl flex items-center justify-center"}>
                <div className="flex flex-col gap-3 sm:gap-5 items-center justify-center max-w-2xl text-center mx-auto`}">
                    ...
                    <Link href={"/signin"} className={"text-white mt-3 text-sm bg-orange-400 px-4 py-2.5 rounded-lg font-semibold"}>Become a Host Today</Link>
                </div>
                </div>
        </div>
    )
}
export default HostCallToAction
